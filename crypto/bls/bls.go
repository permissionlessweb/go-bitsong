...
func VerifyMultipleSignatures(height uint64, sigs [][]byte, msgs [][32]byte, pubKeys []common.PublicKey) (bool, error) {
	return blst.VerifyMultipleSignatures(height, sigs, msgs, pubKeys)
}
